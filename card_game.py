...
CARD_DEFINITIONS = {
    "Hand of Glory": {
        "name": "Hand of Glory",
        "description": "Bask in the light of the Hand! While lit, you cannot be killed by Cultists during Night. Extinguishes by Morning and may only be played once per game.",
        "phase_restriction": ["Evening"],
        "target_type": "self",
        "effect_type": "hand_of_glory",
        "is_public": True,
        "reveals_player": True,
        "sacrifice_cards": 1,
        "dead_card": False,
        "duration_rounds": 0, // Duration is handled manually
    },
    "Mark of the Beast": { 
...
class Player:
    def __init__(self, player_id, name):
        ...
        self.used_once_per_game_cards = set() # Add this line
